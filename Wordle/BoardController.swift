...
class BoardController: NSObject,
    ...
    var isGameDone: Bool {
        return numTimesGuessed >= numItemsPerRow * numRows
    }
    ...
    private func applyNumLettersSettings(with settings: [String: Any]) {
        // START YOUR CODE HERE
        // ...
        guard let numLetters = settings[kNumLettersKey] as? Int else { return }
    ...
    private func applyNumGuessesSettings(with settings: [String: Any]) {
        // START YOUR CODE HERE
        // ...
        guard let numGuesses = settings[kNumGuessesKey] as? Int else { return }
    ...
    private func applyThemeSettings(with settings: [String: Any]) {
        ...
        // ...
        print(goalWord)
        guard let themeSettings = settings[kWordThemeKey] as? String else { return }
        if let theme = WordTheme(rawValue: themeSettings) {
            self.goalWord = WordGenerator.generateGoalWord(with: theme)
        } else {
            return
        }
    ...
    private func applyIsAlienWordleSettings(with settings: [String: Any]) {
        // START YOUR CODE HERE
        // ...
        guard let isAlienWordle = settings[kIsAlienWordleKey] as? Bool else { return }
